          ...
          <div className="mt-3 w-full rounded-md border bg-white p-3 shadow-2xl shadow-neutral-700">
            ...
            <div className="border-t border-gray-200">
              <div className="container mx-auto flex pt-5">
                <a role="button" tabIndex={0} href="/inventory" className="ml-auto mr-2 flex items-center rounded bg-[#fd0223] px-4 py-3 font-bold text-white duration-300 hover:bg-[#fd0223] sm:mr-5">
                  Choose Later
