...
const HomeHero = () => {
  return (
    ...
    <div className="bg-[#7481ff] bg-cover bg-top bg-repeat-y text-center" style={{backgroundImage: 'url("https://vehicleapprovalcentre.com/_next/static/media/front-lead-bg.2c0e8fe8.svg")', backgroundSize: '110%'}}>
        ...
        <div className="xl:mx-16">
          <div className="mx-auto grid w-full gap-3 pt-8 lg:grid-cols-3">
            <div className="flex flex-col px-4 xl:mx-4 pb-4 lg:mx-1 gap-2  lg:px-0 lg:pb-5 xl:pb-5">
              <a href="/#" role="button" tabIndex={0} className="py-[0.85rem] hover:bg-gray-300 duration-300 bg-white text-[#7481ff] mb-2 flex text-center gap-3 justify-center w-full rounded-lg text-lg font-bold shadow-md" style={{boxShadow: '0 .3rem 1rem rgba(0, 0, 0, .5)'}}>
                Get Pre-Approved
