            ...
            <div className="gap-4 sm:flex">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div>
                    <a href="#" className="text-sm text-gray-500 hover:underline"> @vehicleapprovalcentre </a>
                  </div>
                </div>
              </div>
              <div className="mt-2 items-center gap-3 sm:mt-0 sm:flex">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-[3px]  ">
        <div className="group visible relative m-0 flex lg:h-[350px]   shrink-0 grow-0 flex-col overflow-hidden bg-white opacity-100 transition-opacity duration-200 ease-in-out">
          <a href="#" target="_blank" rel="noopener noreferrer nofollow">
            ...
            <div className="absolute inset-0 flex flex-col justify-end bg-black bg-opacity-50 p-4 text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
              {/* Likes */}
              <div className="flex items-center">
                <svg className="mr-2 h-5 w-5" viewBox="0 0 24 24">
                  <path d="M17.7,1.5c-2,0-3.3,0.5-4.9,2.1c0,0-0.4,0.4-0.7,0.7c-0.3-0.3-0.7-0.7-0.7-0.7c-1.6-1.6-3-2.1-5-2.1C2.6,1.5,0,4.6,0,8.3 c0,4.2,3.4,7.1,8.6,11.5c0.9,0.8,1.9,1.6,2.9,2.5c0.1,0.1,0.3,0.2,0.5,0.2s0.3-0.1,0.5-0.2c1.1-1,2.1-1.8,3.1-2.7 c4.8-4.1,8.5-7.1,8.5-11.4C24,4.6,21.4,1.5,17.7,1.5z M14.6,18.6c-0.8,0.7-1.7,1.5-2.6,2.3c-0.9-0.7-1.7-1.4-2.5-2.1 c-5-4.2-8.1-6.9-8.1-10.5c0-3.1,2.1-5.5,4.9-5.5c1.5,0,2.6,0.3,3.8,1.5c1,1,1.2,1.2,1.2,1.2C11.6,5.9,11.7,6,12,6.1 c0.3,0,0.5-0.2,0.7-0.4c0,0,0.2-0.2,1.2-1.3c1.3-1.3,2.1-1.5,3.8-1.5c2.8,0,4.9,2.4,4.9,5.5C22.6,11.9,19.4,14.6,14.6,18.6z" />
                </svg>
                <span>2</span>
              </div>
              <div className="mt-2  flex justify-center text-center items-center text-sm text-gray-200">Another round of happy customers! Happy Saturday everyone! 🎉 #NewCar #HappyCustomers #NewCarFeeling #VACFam</div>
            </div>
          </a>
        </div>
        <div className="group visible relative m-0 flex lg:h-[350px]  shrink-0 grow-0 flex-col overflow-hidden bg-white opacity-100 transition-opacity duration-200 ease-in-out">
