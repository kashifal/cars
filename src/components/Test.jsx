  ...
  return (
    <div>
      ...
      <div className="flex flex-col mt-6 my-5 sm:mx-5 xl:mx-28 gap-4 lg:flex-row">
        ...
        <div className="w-[100%]">
          <div className="sm:flex lg:gap-24 w-full justify-between">
            <div className="col-md-4 sm:w-[100%] relative flex mx-2 items-center">
              <input type="search" id="example-search-input" placeholder="Search by make, model, or keyword" className="form-input w-full rounded-l-md border p-2 text-sm font-light" />
              <span className="absolute bottom-0 right-0 top-0 flex items-center border border-gray-100 justify-center rounded-r-md border-l border-gray-300 bg-white px-2">
                <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="magnifying-glass" className="h-4 w-4 text-gray-500" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          ...
          {/* Add a container for the car cards */}
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
            {[
              {
                img: "https://vehicle-approval-centre-images.s3.ca-central-1.amazonaws.com/1V2BR2CA6NC562889-0.jpg",
                name: "Volkswagen Atlas 2022",
                model: "V6 SEL 4MOTION",
                price: "37,995.00",
                km: "90,000",
                transmission: "Automatic"
              },
              {
                img: "https://vehicle-approval-centre-images.s3.ca-central-1.amazonaws.com/5TDERKEC9NS148187-0.jpg",
              ...
              {
                img: "https://vehicle-approval-centre-images.s3.ca-central-1.amazonaws.com/2HKRW2H95NH229155-0.jpg",
              ...
              {
                img: "https://vehicle-approval-centre-images.s3.ca-central-1.amazonaws.com/5N1AZ2DS8LC766272-0.jpg",
                name: "Nissan Murano 2021",
                model: "SL AWD",
                price: "36,495.00",
                km: "55,000",
                transmission: "Automatic"
              ...
              {
                img: "https://vehicle-approval-centre-images.s3.ca-central-1.amazonaws.com/W1K3G4FB7LJ225542-0.jpg",
                name: "Mercedes-Benz CLA 2020",
                model: "250 4MATIC",
                price: "39,995.00",
                km: "48,000",
                transmission: "Automatic"
              ...
              {
                img: "https://vehicle-approval-centre-images.s3.ca-central-1.amazonaws.com/3CZRU6H77MM100664-0.jpg",
                name: "Honda HR-V 2021",
                model: "Sport AWD",
                price: "29,995.00",
                km: "35,000",
                transmission: "Automatic"
              ...
              {
                img: "https://vehicle-approval-centre-images.s3.ca-central-1.amazonaws.com/WDDSJ4GB2JN686611-0.jpg",
              ...
              {
                img: "https://vehicle-approval-centre-images.s3.ca-central-1.amazonaws.com/2T3R1RFV0MW183391-0.jpg",
              ...
              {
                img: "https://vehicle-approval-centre-images.s3.ca-central-1.amazonaws.com/5FNRL6H94NB503654-0.jpg",
