      ...
      <div className="container mx-auto text-white">
        <div className="flex justify-between items-center flex-wrap">
          <div className="flex-col  items-center">
            ...
            <p className="text-sm mt-2 ml-3 md:mt-0">© Copyright 2024 Auto Mart</p>
          </div>
          {/* Navigation Links */}
          <div className="flex-col">
            <div className="flex flex-col px-3 justify-between mt-6 gap-3">
              ...
              <ul className="flex flex-wrap items-center gap-5 text-sm">
                ...
                <li><Link to="/clearance" className="hover:underline">Clearance</Link></li>
                <li><Link to="/trade" className="hover:underline">Sell &amp; Trade</Link></li>
