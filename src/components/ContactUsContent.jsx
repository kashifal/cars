                ...
                <div className=" rounded     md:p-">
                  <form id="contact-form" className="w-full  space-y-6">
                    ...
                    <div className="flex justify-start">
                      <button type="submit" className="bg-white hover:bg-primary-dark rounded-lg px-10 py-5 text-lg font-bold text-[#fd0223] border hover:bg-gray-200 border-[#7481ff] shadow-2xl  transition duration-200">Submit</button>
                    </div>
                  </form>
                </div>
              </div>
