          ...
          <div className="w-full border-0 border-gray-400 rounded-xl  md:w-[55%]">
            <div className="rounded-md  bg-white border">
              ...
              <div className="bg-[#F9F9FA] border-b border-gray-300  px-4 py-3">
                <h4 className="text-2xl font-bold text-[#7481FF] mb-0">Get Top Value for Your Car – Hassle Free Process</h4>
              </div>
              {/* Card Body */}
              <div className="p-4 pb-7 py-5">
                <p className="text-[#41456B]">
                  Looking to sell or trade your car? At Vehicle Approval Centre in Halifax, we make it easy with competitive appraisals, quick transactions, and a transparent process.
                </p>
        ...
        <div className="mb-5 w-full md:mt-16 mt-12 ">
          <div className="w-full flex justify-center  mx-auto   ">
            <div className="-mt-12 rounded bg-white p-6 text-center  ">
              <h3 className="mb-12 text-2xl md:text-[2rem] mt-4 font-semibold text-[#7481FF]">Or contact us with some details on your vehicle!
              </h3>
              <form id="contact-form" className=" space-y-6">
                ...
                <div className="flex justify-start">
                  <button type="submit" className="bg-primary hover:bg-primary-dark rounded-lg px-10 py-5 text-lg font-bold text-[#7481ff] border hover:bg-gray-200 border-[#7481ff] shadow-2xl  transition duration-200">Submit</button>
                </div>
              </form>
            </div>
          </div>
