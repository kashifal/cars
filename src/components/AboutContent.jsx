...
import bg from '../assets/Infiniti Q50.jpg'
    ...
    <div>
     <div>
        ...
        <div className="w-full relative min-h-[500px]  bg-top bg-contain py-20" style={{background: 'url("")'}}>
          <img src={bg} className="absolute top-0 h-[500px] w-full object-cover" alt="" />
          <div className="bg-[#FFFFFF] z-[2] max-w-7xl mx-auto  border border-gray-300 shadow-sm">
            <div className="relative bg-gray-50  max-w-xl mt-9 mx-2 z-[4]">
              ...
              <div className="card-body flex flex-col relative z-[4] space-y-4 p-11">
                {/* Location Link */}
                <a href="" target="_blank" className="btn btn-link hover:text-primary flex items-center text-left text-gray-700">
                ...
                {/* Phone Link */}
                <a href="#" className="btn btn-link hover:text-primary flex items-center text-left text-gray-700">
                ...
                <div className="flex space-x-3">
                  <a href="#" target="_blank" className="  text-white flex h-10 w-10 items-center justify-center bg-[#fd0223] rounded-full border hover:text-gray-300">
