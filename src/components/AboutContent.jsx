            ...
            <div className="relative bg-gray-50  max-w-xl mt-9 mx-2 z-[4]">
              ...
              <div className="card-body flex flex-col relative z-[4] space-y-4 p-11">
                ...
                <a href="https://maps.app.goo.gl/L1j7rVfENKkNKg1Q7" target="_blank" className="btn btn-link hover:text-primary flex items-center text-left text-gray-700">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" className="text-[#7481FF] mr-2 h-5 w-5">
                ...
                <a href="tel:19029012105" className="btn btn-link hover:text-primary flex items-center text-left text-gray-700">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="text-[#7481FF] mr-2 h-5 w-5">
                ...
                <div className="flex space-x-3">
                  <a href="https://www.instagram.com/vehicleapprovalcentre/" target="_blank" className="  text-white flex h-10 w-10 items-center justify-center bg-[#7481FF] rounded-full border hover:text-gray-300">
        ...
        <div className="lg:px-20 mb-7 mx-auto py-4">
          <div className="flex gap-10 flex-wrap">
            ...
            <div className="w-full px-4 md:w-8/12">
              <h3 className="text-3xl font-bold text-[#7481FF]">Our Journey</h3>
              ...
              <h3 className="mt-6 text-3xl  font-bold text-[#7481FF]">The Vision</h3>
              ...
              <h3 className="mt-6 text-3xl  font-bold text-[#7481FF]">Turning Vision into Reality</h3>
              ...
              <h3 className="mt-6 text-3xl  font-bold text-[#7481FF]">Building Trust, One Customer at a Time</h3>
              ...
              <h3 className="mt-6 text-3xl  font-bold text-[#7481FF]">Continuing the Journey</h3>
            ...
            <div className="flex w-[60%] mx-auto flex-col items-center  md:px-4 md:w-[27%]">
              <svg xmlns="http://www.w3.org/2000/svg" className="my-10 text-[#7481FF]" style={{fontSize: '250px'}} viewBox="0 0 576 512">
                <path fill="currentColor" d="M256 32l-74.8 0c-27.1 0-51.3 17.1-60.3 42.6L3.1 407.2C1.1 413 0 419.2 0 425.4C0 455.5 24.5 480 54.6 480L256 480l0-64c0-17.7 14.3-32 32-32s32 14.3 32 32l0 64 201.4 0c30.2 0 54.6-24.5 54.6-54.6c0-6.2-1.1-12.4-3.1-18.2L455.1 74.6C446 49.1 421.9 32 394.8 32L320 32l0 64c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-64zm64 192l0 64c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-64c0-17.7 14.3-32 32-32s32 14.3 32 32z" />
              </svg>
              <svg xmlns="http://www.w3.org/2000/svg" className="my-10 hidden text-[#7481FF] md:block" style={{fontSize: '250px'}} viewBox="0 0 576 512">
