  ...
  return (
    <div>
                ...
                <div className="w-full max-w-lg">
                  <form id="login-form" data-testid="login-form" className="flex flex-col space-y-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <input id="user-email" name="user-email" type="email" className="mt-1 rounded border border-gray-300 p-2 duration-300 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500" placeholder autoComplete="email" />
                    </div>
                    {/* Submit Button */}
                    <button id="login-button" type="submit" className="w-full rounded bg-[#7481FF] px-4 py-[0.4rem] text-white duration-300 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2" data-testid="login-button">Next</button>
                  </form>
                </div>
              </div>
            </div>
        ...
        <footer className="flex items-center justify-center mt-12 " id="portal-layout-footer">
          <a className="flex items-center space-x-2 text-gray-400 hover:text-blue-600" target="_blank" rel="noopener noreferrer" href="https://www.atlassian.com/software/jira/service-desk/powered-by?utm_medium=jira-in-product&utm_source=jira_service_desk_portal_footer&utm_content=vehicleapprovalcentre">
